<x-app-layout>
    <x-slot name="header">
        ...
        <div class="ml-2 md:ml-4">
            <button type="button" class="w-32 h-8 bg-indigo-500 text-white md:ml-12 hover:bg-indigo-600 rounded" onclick="location.href='{{ route('stint_list') }}'" >StintList</button>
        </div>
    ...
    <div class="py-4">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <form method="get" action="{{ route('StintCSV_download2') }}" >
            ...
            <div class="flex p-2 mt-2 w-full ">
                <div class="ml-2 md:ml-0 md:mt-0">
                    <button type="button" class="w-40 h-8 text-sm bg-pink-400 text-white hover:bg-pink-500 rounded" onclick="location.href='{{ route('stint_DL') }}'" >条件クリア</button>
                </div>
