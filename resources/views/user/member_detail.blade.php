                    ...
                    <form method="get" action=""  enctype="multipart/form-data">
                        ...
                        <div class="-m-2">
                            <div class="p-2 mx-auto">
                                ...
                                <div class="p-2 w-full mx-auto">
                                    <div class="flex mx-auto">
                                        ...
                                        <div class="relative">
                                            ...
                                            <div  id="area_name" name="area_name" value="{{$user->area_name}}" class="pl-2 w-48 h-6 text-sm items-center bg-gray-100 border rounded">{{$user->area_name}}
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="md:flex px-2 mx-auto">
