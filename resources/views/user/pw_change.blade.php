                ...
                <div class="p-2 text-gray-900 dark:text-gray-100">
                    <section class="text-gray-600 body-font relative">
                        ...
                        <div class="flex flex-col text-center w-full mb-0">
                            <h1 class="sm:text-3xl text-2xl font-medium title-font mb-0 text-gray-900">パスワード変更</h1>
                        </div>
                        <div class="lg:w-1/2 md:w-2/3 mx-auto">
                            ...
                            <form method="post" action="{{ route('pw_update',['user'=>$login_user->id]) }}">
                            {{-- @method('put') --}}
                            @csrf
                            ...
                            <div class="p-2 w-full mx-auto">
                                <div class="relative ">
                                <label for="name" class="w-full leading-7 text-sm text-gray-600">ネーム</label>
                                <div type="text" id="name" name="name" value="{{ $login_user->name }}" required class="w-full bg-gray-100 bg-opacity-50 rounded border border-gray-300 focus:border-indigo-500 focus:bg-white focus:ring-2 focus:ring-indigo-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out">{{ $login_user->name }}
                                </div>
                                </div>
                                {{-- <div class="p-2 w-full mx-auto"> --}}
                                <div class="relative">
                                ...
                                <button type="button" onclick="location.href='{{ route('ac_info') }}'" class="text-black bg-gray-300 border-0 py-2 px-8 focus:outline-none hover:bg-gray-300 rounded text-lg">戻る</button>
