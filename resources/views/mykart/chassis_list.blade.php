    ...
    <x-slot name="header">
        ...
        <div class="flex">
            ...
            <div class="ml-2 md:ml-2">
                <button type="button" class="w-32 h-8 text-sm bg-indigo-500 text-white hover:bg-indigo-600 rounded" onclick="location.href='{{ route('maker_index') }}'" >Maker List</button>
            </div>
            <div class="ml-2 ">
                <button type="button" class="w-32 h-8 text-sm bg-green-500 text-white ml-0 hover:bg-green-600 rounded" onclick="location.href='{{ route('chassis_create') }}'" >新規登録</button>
            </div>
        </div>
        <br>
        <div class="ml-4 md:ml-13 text-indigo-500">
            ※”Chassis No”をクリックするとMyChassis詳細の確認ができます。<br>
            ※”Maker”をクリックするとMaker詳細の確認ができます。
        </div>
