    ...
    <x-slot name="header">
        ...
        <div class="flex">
            ...
            <div class="ml-2 md:ml-2">
                <button type="button" class="w-32 h-8 text-sm bg-indigo-500 text-white hover:bg-indigo-600 rounded" onclick="location.href='{{ route('tire_index') }}'" >Tire_List</button>
            </div>
            <div class="ml-2 ">
