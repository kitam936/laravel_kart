<x-app-layout>
    ...
    <div class="py-4">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <form method="POST" action="{{ route('mytire_store') }}" enctype="multipart/form-data">
                @csrf


                <div class="">
                    <div class="ml-2 mr-2">
                        <x-label for="tire_id" value="タイヤ" class="mt-1"/>
                        <div class="ml-0 w-52">
                ...
                <div class="flex">
                    ...
                    <div class="relative">
                        ...
                        <x-textarea id="my_tire_info" name="my_tire_info" rows="3" required class="ml-2 w-full bg-gray-100 bg-opacity-50 rounded border border-gray-300 focus:border-indigo-500 focus:bg-white focus:ring-2 focus:ring-indigo-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out">{{ old('my_tire_info')  }}</x-textarea>
                    </div>
                </div>
