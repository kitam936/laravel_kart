                ...
                <div class="p-2 text-gray-900 dark:text-gray-100">
                    <section class="text-gray-600 body-font relative">
                        ...
                        <div class="flex flex-col text-center w-full mb-0">
                            <span class="sm:text-3xl font-medium title-font mb-0 text-indigo-600">ホームコースに登録しますか？</span>
                        </div>
                        <div class="lg:w-1/2 md:w-2/3 mx-auto">
                            {{-- <x-input-error2 :messages="$errors->get('email')" class="mt-2" /> --}}

                            <form method="post" action="{{ route('favorite_store',['circuit'=>$circuit->id]) }}">
                            {{-- @method('put') --}}
                            @csrf
                            ...
                            <div class="p-2 w-full mx-auto">
                                ...
                                <button type="submit" class="h-8 w-32 text-white bg-green-500 border-0 py-2 px-8 focus:outline-none hover:bg-green-600 rounded text-sm">登録</button>
                                </div>
                            </div>
                            {{-- </div> --}}
                            </form>
