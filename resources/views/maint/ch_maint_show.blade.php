<x-app-layout>
    <x-slot name="header">
        ...
        <form>
            ...
            <x-input type="hidden" id="ch_maint_id" name="ch_maint_id" value="{{ $maint->maint_id }}"/>
    ...
    <div class="py-4">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="flex">
                ...
                <div class="flex ml-2 mr-4 mt01">
                    <div class="relative w-32">
                        <x-label for="ch_maint_date" value="実施日" class="mt-1"/>
                ...
                <div class="ml-2 mr-4 ">
                    <div class="relative w-48 mr-2 ">
                        <x-label for="maint_name" value="カテゴリー" class="mt-1"/>
                        <div class="pl-2 w-full h-6 text-sm items-center bg-gray-100 border rounded" id="maint_name" name="maint_name"  value="{{ $maint->ch_maint_name }}">{{ $maint->ch_maint_name  }}
                        </div>
                    </div>
            ...
            @if(!empty($maint->ch_maint_info))
            <div class="ml-2 mr-4">
                <x-label for="ch_maint_info" value="詳細" class="mt-1"/>
                <div row="5" id="ch_maint_info" class="pl-2 w-full text-sm items-center bg-gray-100 border rounded"  name="ch_maint_info" >{!! nl2br(e($maint->maint_info)) !!}</div>
            </div>
            @endif
