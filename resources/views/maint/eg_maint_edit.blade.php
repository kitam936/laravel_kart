<x-app-layout>
    <x-slot name="header">
        ...
        <div class="ml-12 md:ml-12">
            <x-input type="hidden" id="myengine_id" name="myengine_id" value="{{ $maint->my_engine_id }}"/>
            <button type="button" class="w-32 h-8 bg-indigo-500 text-white md:ml-3232 hover:bg-indigo-600 rounded" onclick="location.href='{{ route('myengine_show',['engine'=>$maint->my_engine_id]) }}'" >MyEngine詳細</button>
        </div>
    ...
    <div class="py-4">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <form method="POST" action="{{ route('eg_maint_update',['maint'=>$maint->maint_id]) }}" >
                @csrf
                <x-input type="hidden" id="myengine_id2" name="myengine_id2" value="{{ $maint->my_engine_id }}"/>
                ...
                <div class="mt-1 ">
                    ...
                    <div class="ml-2 mr-2">
                        <x-label for="eg_maint_category_id" value="カテゴリー" class="mt-1"/>
                        <div class="ml-0 w-full">
                                ...
                                <option value="{{ $maint->eg_maint_category_id }}" @if(\Request::get('eg_maint_category_id') == '0') selected @endif >{{ $maint->eg_maint_name }}</option>
                    ...
                    <div class="relative">
                        <x-label for="eg_maint_info" value="内容" class="mt-1 ml-2 "/>
