<x-app-layout>
    <x-slot name="header">
        ...
        <div class="flex">
            ...
            <div class="ml-2 ">
                <button type="button" class="w-32 h-8 bg-green-500 text-sm text-white ml-0 hover:bg-green-600 rounded" onclick="location.href='{{ route('engine_create') }}'" >新規登録</button>
            </div>
        </div>
        <br>
